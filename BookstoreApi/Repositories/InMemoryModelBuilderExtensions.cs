    ...
    public static class InMemoryModelBuilderExtensions
    {
        public static void HasSeedData(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookEntity>().HasData(
                new BookEntity { BookId = 1, BookDetailId = 1, AuthorId = 1, Title = "Harry Potter and the Philosopher's Stone" },
                new BookEntity { BookId = 2, BookDetailId = 2, AuthorId = 1, Title = "Harry Potter and the Chamber of Secrets" },
                new BookEntity { BookId = 3, BookDetailId = 3, AuthorId = 2, Title = "A Game of Thrones" },
                new BookEntity { BookId = 4, BookDetailId = 4, AuthorId = 2, Title = "A Clash of Kings" }
            );
        }
    }
}
